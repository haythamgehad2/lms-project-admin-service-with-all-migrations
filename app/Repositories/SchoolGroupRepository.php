...
class SchoolGroupRepository extends Repository
{
    public function model(): string
    {
        return SchoolGroup::class;
    }
    ...
    public function getAll(array $options, array $relation,string $name = null): LengthAwarePaginator|Collection
    {
        ...
        if(isset($name)){
            ...
            $query = $query->whereLike(['name->'.$dynamicLocale,'country.name->'.$dynamicLocale ,'owner.email'], $name);
        }
