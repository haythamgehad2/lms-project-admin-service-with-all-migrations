...
// use App\Repositories\Interfaces\RepositoryInterface; //@hint Return Expction
...
abstract class Repository
{
     ...
     */
    public function updateOrCreate(array $dataUpdate, array $dataCreate)
    {
            return $this->model->updateOrCreate($dataUpdate,$dataCreate);
     ...
     * @return AppModel|bool|Model|int
     */
    public function updateOrCreateItem(array $data, $id, string $attribute = 'id')
    {
    ...
    {
        return $this->model->find($id, $columns)->with($relations);
    }
}
