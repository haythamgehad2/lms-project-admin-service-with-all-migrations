...
return new class extends Migration
{
    ...
    {
        Schema::create('mission_paper_works', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('mission_id')->nullable();
            $table->foreign('mission_id')->references('id')->on('missions')->cascadeOnDelete()->cascadeOnUpdate();
            $table->unsignedBigInteger('peper_work_id')->nullable();
            $table->foreign('peper_work_id')->references('id')->on('peper_works')->cascadeOnDelete()->cascadeOnUpdate();
    ...
    {
        Schema::dropIfExists('mission_paper_works');
    }
};
