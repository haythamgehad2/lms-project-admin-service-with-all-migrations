...
class CountriesTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
		...
		$countries = array(
			array('code' => 'SA', 'name' =>['ar' =>'السعودية','en'=>'KSA']),
			array('code' => 'CA', 'name' => ['ar' =>'كندا','en'=>'Canda']),
			array('code' => 'MA', 'name' => ['ar' =>'المغرب','en'=>'Morraco']),
			array('code' => 'EG', 'name' => ['ar' =>'مصر','en'=>'Egypt']),
			array('code' => 'DZ', 'name' =>['ar' =>'الجزائر','en'=>'Algeria'])
